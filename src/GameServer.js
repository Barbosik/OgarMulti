...
function GameServer() {
    ...
    this.config = {
        ...
        serverWsModule: 0,            // Which WebSocket module to use, 0 = WS, 1 = UWS
...
GameServer.prototype.loadWebSocketModule = function () {
    if (!this.config.serverWsModule) {
    ...
    WebSocket.prototype.sendPacket = function (packet) {
        ...
        if (this.readyState == WebSocket.OPEN) {
            if (this._socket.writable !== undefined && !this._socket.writable) {
                return;
            }
